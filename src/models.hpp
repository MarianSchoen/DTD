...
namespace dtd {
  namespace models {
    ...
    mat invxtgx(mat const & x, vec const & g, ftype eps);
    class GoertlerModel {
    private:
    ...
    public:
      ...
      ftype evaluate(vec const & params) const {
        return evaluate(params, invxtgx(m_x, params, inv_prec));
      }
